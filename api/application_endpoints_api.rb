...
MyApp.add_route('GET', '/api/v2/application/connections', {
  ...
  "nickname" => "v2_application_connections_get", 
  "responseClass" => "inline_response_200_3", 
  "endpoint" => "/v2/application/connections", 
...
MyApp.add_route('GET', '/api/v2/application/credentials', {
  ...
  "nickname" => "v2_application_credentials_get", 
  "responseClass" => "inline_response_200_4", 
  "endpoint" => "/v2/application/credentials", 
...
MyApp.add_route('GET', '/api/v2/application/measurements', {
  ...
  "nickname" => "v2_application_measurements_get", 
  "responseClass" => "inline_response_200_5", 
  "endpoint" => "/v2/application/measurements", 
...
MyApp.add_route('GET', '/api/v2/application/trackingReminders', {
  ...
  "nickname" => "v2_application_tracking_reminders_get", 
  "responseClass" => "inline_response_200_1", 
  "endpoint" => "/v2/application/trackingReminders", 
...
MyApp.add_route('GET', '/api/v2/application/updates', {
  ...
  "nickname" => "v2_application_updates_get", 
  "responseClass" => "inline_response_200_6", 
  "endpoint" => "/v2/application/updates", 
...
MyApp.add_route('GET', '/api/v2/application/userVariableRelationships', {
  ...
  "nickname" => "v2_application_user_variable_relationships_get", 
  "responseClass" => "inline_response_200_7", 
  "endpoint" => "/v2/application/userVariableRelationships", 
...
MyApp.add_route('GET', '/api/v2/application/userVariables', {
  ...
  "nickname" => "v2_application_user_variables_get", 
  "responseClass" => "inline_response_200_8", 
  "endpoint" => "/v2/application/userVariables", 
...
MyApp.add_route('GET', '/api/v2/application/variableUserSources', {
  ...
  "nickname" => "v2_application_variable_user_sources_get", 
  "responseClass" => "inline_response_200_9", 
  "endpoint" => "/v2/application/variableUserSources", 
...
MyApp.add_route('GET', '/api/v2/application/votes', {
  ...
  "nickname" => "v2_application_votes_get", 
  "responseClass" => "inline_response_200_10", 
  "endpoint" => "/v2/application/votes", 
  "notes" => "Get all Votes",
  "parameters" => [
    {
      "name" => "access_token",
